...
VALUES ('Empyre'), ('Spider-Man'), ('Marvel Knigths'), ('Storm');
...
VALUES ((SELECT comic_id FROM comics WHERE comic_name='Empyre #1'), (SELECT collection_id FROM collections WHERE collection_name='User Collection')),
       ...
       ((SELECT comic_id FROM comics WHERE comic_name='Storm Vol 2 #1'), (SELECT collection_id FROM collections WHERE collection_name='User Collection'));
